#ifndef DC_Calib_Comp_HMS_h
#define DC_Calib_Comp_HMS_h
...
class DC_Calib_Comp_HMS : public TSelector {
 public :
  ...
  TTreeReaderArray<Double_t> T_coin_hEL_CLEAN_tdcTime = {fReader, "T.coin.hEL_CLEAN_ROC2_tdcTime"};

  DC_Calib_Comp_HMS(TTree * /*tree*/ =0) {}
  virtual ~DC_Calib_Comp_HMS() { }
  ...
  ClassDef(DC_Calib_Comp_HMS,0);
};

#endif

#ifdef DC_Calib_Comp_HMS_cxx
void DC_Calib_Comp_HMS::Init(TTree *tree)
{
  fReader.SetTree(tree);
}

Bool_t DC_Calib_Comp_HMS::Notify()
{
  return kTRUE;
}

#endif // #ifdef DC_Calib_Comp_cxx
