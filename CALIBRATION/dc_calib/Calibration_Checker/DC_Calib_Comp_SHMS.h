#ifndef DC_Calib_Comp_SHMS_h
#define DC_Calib_Comp_SHMS_h
...
class DC_Calib_Comp_SHMS : public TSelector {
 public :
  ...
  ClassDef(DC_Calib_Comp_SHMS,0);
};

#endif

#ifdef DC_Calib_Comp_SHMS_cxx
void DC_Calib_Comp_SHMS::Init(TTree *tree)
{
  fReader.SetTree(tree);
}

Bool_t DC_Calib_Comp_SHMS::Notify()
{
  return kTRUE;
}
