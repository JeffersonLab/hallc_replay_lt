...
void run_DC_Calib_Check_KaonLT(Int_t RunNumber = 0, Int_t MaxEvent = 0, string Detector = "")
{
  ...
  if(Hostname.Contains("farm")){
    rootFileNameString1 = Form("/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/ROOTfiles/Calib/DC/%s_DC_Calib_Pt1_%i_%i.root", Detector.c_str(), RunNumber, MaxEvent);
    rootFileNameString2 = Form("/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/ROOTfiles/Calib/DC/%s_DC_Calib_Pt2_%i_%i.root", Detector.c_str(), RunNumber, MaxEvent);
    Outpath = "/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/OUTPUT/Calib/DC";
    Histopath = "/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/HISTOGRAMS/Calib/DC";
  }
    ...
    rootFileNameString1 = Form("/home/cdaq/kaonLT-2021/hallc_replay_lt/ROOTfiles/Calib/DC/%s_DC_Calib_Pt1_%i_%i.root", Detector.c_str(), RunNumber, MaxEvent);
    rootFileNameString2 = Form("/home/cdaq/kaonLT-2021/hallc_replay_lt/ROOTfiles/Calib/DC/%s_DC_Calib_Pt2_%i_%i.root", Detector.c_str(), RunNumber, MaxEvent);
    Outpath = "/home/cdaq/kaonLT-2021/hallc_replay_lt/OUTPUT/Calib/DC";
    Histopath = "/home/cdaq/kaonLT-2021/hallc_replay_lt/HISTOGRAMS/Calib/DC";
    }
  ...
  for (Int_t i = 0; i < 6; i++){
    ...
    cDC1_Res->cd(i+1);
    ((TH1F*)f1->Get(Name))->SetLineColor(kRed); ((TH1F*)f1->Get(Name))->Draw(); ((TH1F*)f2->Get(Name))->Draw("SAME");
