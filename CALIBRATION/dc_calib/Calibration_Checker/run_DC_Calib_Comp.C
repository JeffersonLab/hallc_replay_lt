...
void run_DC_Calib_Comp(Int_t RunNumber = 0, Int_t MaxEvent = 0, string Detector = "")
{
  ...
  if(Hostname.Contains("farm")){
    rootFileNameString = Form("/group/c-kaonlt/USERS/${USER}/hallc_replay_lt/ROOTfiles/Calib/DC/%s_DC_Calib_Check_Coin_%i_%i.root", Detector.c_str(), RunNumber, MaxEvent);
    Outpath = "/volatile/hallc/c-kaonlt/${USER}/OUTPUT/Calib/DC";
    Histopath = "/volatile/hallc/c-kaonlt/${USER}/HISTOGRAMS/Calib/DC";
  }
