...
#define DetTCuts_Coin_MKJ_cxx

#include "DetTCuts_Coin_MKJ.h"
#include <TH1.h>
#include <TH2.h>
#include <TF1.h>
#include <TStyle.h>
...
void DetTCuts_Coin_MKJ::Begin(TTree * /*tree*/)
{
  printf("\n\n");
  TString option = GetOption();
}

void DetTCuts_Coin_MKJ::SlaveBegin(TTree * /*tree*/)
{
  printf("\n\n");
  TString option = GetOption();
...
Bool_t DetTCuts_Coin_MKJ::Process(Long64_t entry)
{
...
void DetTCuts_Coin_MKJ::SlaveTerminate()
{
}

void DetTCuts_Coin_MKJ::Terminate()
{
