...
// Test version in case new hcana changes has modified anything //
// Note - This script is to set the detector time windows, NOT the detector reference times //

#ifndef DetTCuts_Coin_MKJ_h
#define DetTCuts_Coin_MKJ_h
...
class DetTCuts_Coin_MKJ : public TSelector {
public :
   TTreeReader    fReader;
 ...
 DetTCuts_Coin_MKJ(TTree * /*tree*/ =0) : fChain(0) {}
   virtual ~DetTCuts_Coin_MKJ() { }
   ...
   ClassDef(DetTCuts_Coin_MKJ,0);
};

#endif

#ifdef DetTCuts_Coin_MKJ_cxx
void DetTCuts_Coin_MKJ::Init(TTree *tree)
{
...
Bool_t DetTCuts_Coin_MKJ::Notify()
{
...
#endif // #ifdef DetTCuts_Coin_MKJ_cxx
