...
while IFS='' read -r line || [[ -n "$line" ]]; do
    ...
    cp "/group/c-kaonlt/USERS/sjdkay/hallc_replay_lt/CALIBRATION/hms_cal_calib/Output/hcal.param.HMS_Cal_Calib_${runNum}_-1" "/group/c-kaonlt/USERS/sjdkay/hallc_replay_lt/PARAM/HMS/CAL/CALIB/hcal_${runNum}.param"
done < "$inputFile"
