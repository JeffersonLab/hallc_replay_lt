void FullReplay_Offline_SetPedDef (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
...
const char* ROOTFileNamePattern = "ROOTfiles/Calib/Timing/RefTime%d_%d.root";
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/CALIBRATION/RefTime.def");
  // Define cuts file
  analyzer->SetCutFile("DEF-files/CALIBRATION/RefTime_Cuts.def");  // optional
