void SHMSCal_Calib_Coin_test (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Calib/Cal/SHMS_Cal_Calib_test_%d_%d.root";
  // Load global parameters
  gHcParms->Define("gen_run_number", "Run Number", RunNumber);
  gHcParms->AddString("g_ctp_database_filename","DBASE/COIN/standard_calib.database");
