void SHMSDC_Calib_Coin_Pt2_Uncalib (Int_t RunNumber = 0, Int_t MaxEvent = 0) {

  // Stephen Kay - University of Regina 30/03/21
  // Note, this script is designed to run on the completely uncalibrated data
  // I.e. it utilisies the online param files
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Calib/DC/SHMS_DC_Calib_Pt2_%d_%d.root";
  // Load global parameters
  gHcParms->Define("gen_run_number", "Run Number", RunNumber);
  gHcParms->AddString("g_ctp_database_filename", Form("DBASE/COIN/SHMS_DCCalib/standard_%d.database", RunNumber));
