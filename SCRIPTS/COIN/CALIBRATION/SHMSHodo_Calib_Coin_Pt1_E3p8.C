void SHMSHodo_Calib_Coin_Pt1_kaonLT (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  gHcParms->AddString("g_ctp_database_filename","DBASE/COIN/DB_KaonLT/standard_KaonLTCalib.database");
