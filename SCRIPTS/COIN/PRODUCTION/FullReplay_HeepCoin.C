void FullReplay_HeepCoin (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/HeeP/coin_replay_Full_Heep_Coin_%d_%d.root";
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/COIN/PRODUCTION/Full_Replay_HeeP_Coin.def"); // New version, slimmed down
  // Define cuts file
