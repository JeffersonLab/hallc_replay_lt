void FullReplay_HeepSingles (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/HeeP/coin_replay_Full_Heep_Singles_%d_%d.root";
