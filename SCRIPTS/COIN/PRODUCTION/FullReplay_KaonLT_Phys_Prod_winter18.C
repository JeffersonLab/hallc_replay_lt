void FullReplay_KaonLT_Phys_Prod_winter18 (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/PRODUCTION/Full_Replay_Pass2_Coin_v2.def"); // New version, slimmed down -- default
  // analyzer->SetOdefFile("DEF-files/CALIBRATION/SHMS_Calib.def"); // calibration Hodo
  // analyzer->SetOdefFile("DEF-files/CALIBRATION/SHMSDC_Calib.def"); // calibration SHMS DC
