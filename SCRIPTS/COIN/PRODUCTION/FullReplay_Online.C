void FullReplay_Online(Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Full_Online_coin_replay_%d_%d.root";
  ...
  analyzer->SetSummaryFile(Form("REPORT_OUTPUT/Full_Online_summary_production_%d_%d.report", RunNumber, MaxEvent)); // optional
