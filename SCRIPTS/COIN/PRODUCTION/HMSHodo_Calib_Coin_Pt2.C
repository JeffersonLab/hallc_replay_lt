B1;5202;0cvoid HMSHodo_Calib_Coin_Pt2 (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfilesHodoCalibPt2/hms_Hodo_Calib_Coin_Pt2_%d_%d.root"; 
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/COIN/PRODUCTION/HMS_HodoCalb.def");
  // Define cuts file
