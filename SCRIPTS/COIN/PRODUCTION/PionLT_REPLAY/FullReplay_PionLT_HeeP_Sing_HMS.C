...
//  gHaEvtHandlers->Add(phelscaler);
  ...
  analyzer->SetSummaryFile(Form("REPORT_OUTPUT/Analysis/General/PionLT_HMS_HeePSing_summary_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  ...
  Form("REPORT_OUTPUT/Analysis/General/PionLT_replay_hms_heepsing_%d_%d.report", RunNumber, MaxEvent));  // optional
