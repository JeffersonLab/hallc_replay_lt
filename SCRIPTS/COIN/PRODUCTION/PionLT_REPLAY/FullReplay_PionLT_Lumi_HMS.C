...
//  pathList.push_back("./cache_pionlt");
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/Lumi/PionLT_replay_luminosity_HMS_%d_%d.root";
  //const char* ROOTFileNamePattern = "/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021_v2/Analysis/Lumi/PionLT_HMS_Lumi_replay_production_%d_%d.root";
  //const char* ROOTFileNamePattern = "/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022_v2/Analysis/Lumi/PionLT_HMS_Lumi_replay_production_%d_%d.root";
  ...
  const char* CurrentFileNamePattern = "PARAM/HMS/BCM/CALIB/BCM_PionLT/bcmcurrent_%d.param";
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/PRODUCTION/Full_Replay_Pass2_Coin_PionLT.def"); // New version of PionLT, slimmed down
  ...
  Form("/volatile/hallc/c-pionlt/junaid/REPORT_OUTPUT/Analysis/Lumi/PionLT_replay_luminosity_HMS_%d_%d.report", RunNumber, MaxEvent));  // optional
...
/*
  ...
  // File to record accounting information for cuts
  analyzer->SetSummaryFile(Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021_v2/SUMMARY_OUTPUT/Lumi/PionLT_HMS_Lumi_summary_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Start the actual analysis.
  analyzer->Process(run);
  // Create report file from template
  //  analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/COIN_PROD.template",
  analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/PionLT_TEMP/PionLT_Offline_Lumi_Sing.template",
  Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021_v2/REPORT_OUTPUT/Lumi/PionLT_replay_HMS_Lumi_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Helicity scalers output
   analyzer->PrintReport("TEMPLATES/HMS/SCALERS/hhelscalers.template",
  			Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021_v2/Scalers/Lumi/PionLT_replay_hms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
   analyzer->PrintReport("TEMPLATES/SHMS/SCALERS/phelscalers.template",
  			Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2021_v2/Scalers/Lumi/PionLT_replay_shms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  

  }
  
  else if (RunNumber >= 14901 && RunNumber <= 17000) {
  // File to record accounting information for cuts
  analyzer->SetSummaryFile(Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022_v2/SUMMARY_OUTPUT/Lumi/PionLT_HMS_Lumi_summary_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Start the actual analysis.
  analyzer->Process(run);
  // Create report file from template
  // analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/COIN_PROD.template",
  analyzer->PrintReport("TEMPLATES/COIN/PRODUCTION/PionLT_TEMP/PionLT_Offline_Lumi_Sing.template",
  Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022_v2/REPORT_OUTPUT/Lumi/PionLT_replay_HMS_Lumi_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Helicity scalers output
  analyzer->PrintReport("TEMPLATES/HMS/SCALERS/hhelscalers.template",
                        Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022_v2/Scalers/Lumi/PionLT_replay_hms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
   analyzer->PrintReport("TEMPLATES/SHMS/SCALERS/phelscalers.template",
                        Form("/cache/hallc/c-pionlt/analysis/PionLT_Fullreplay_Analysis_Files_Pass1_2022_v2/Scalers/Lumi/PionLT_replay_shms_helicity_scalers_%d_%d.report", RunNumber, MaxEvent));  // optional  
  }
*/
