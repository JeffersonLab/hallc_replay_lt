...
//  pathList.push_back("./cache_pionlt");
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/General/PionLT_Coin_replay_production_pTRIG6_%d_%d.root";
...
//  gHaEvtHandlers->Add(hhelscaler);
  ...
  Form("REPORT_OUTPUT/Analysis/General/PionLT_replay_coin_production_pTRIG6_%d_%d.report", RunNumber, MaxEvent));  // optional
