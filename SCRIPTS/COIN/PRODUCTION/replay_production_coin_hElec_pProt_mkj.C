void replay_production_coin_hElec_pProt_mkj (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/General/coin_replay_production_mkj_%d_%d.root";
  ...
  */
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/Archive/COIN/PRODUCTION/coin_production_hElec_pProt_mkj.def");
  // Define cuts file
