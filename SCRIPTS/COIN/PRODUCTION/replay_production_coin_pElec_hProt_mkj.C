void replay_production_coin_pElec_hProt_mkj (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/General/coin_replay_production_pElec_hProt_mkj_%d_%d.root";
  ...
  */
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/PRODUCTION/coin_production_pElec_hProt_mkj.def");
  // Define cuts file
