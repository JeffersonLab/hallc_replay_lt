void replay_production_hms_coin_Cer(Int_t RunNumber=0, Int_t MaxEvent=0, Int_t FirstEvent=0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Calib/hms_cer_calib_%d_%d.root";
  ...
  */
  ...
  analyzer->SetOdefFile("/DEF-files/CALIBRATION/HMS_Calib_Cer.def");
  // Define cuts file
