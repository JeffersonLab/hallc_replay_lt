void replay_production_hms_coin_OPTICS(Int_t RunNumber=0, Int_t MaxEvent=0, Int_t FirstEvent=0) {
  ...
  */
  ...
  analyzer->SetOdefFile("DEF-files/PRODUCTION/50k/Full_Replay_50k_HMS_Optics.def");
  // Define cuts file
