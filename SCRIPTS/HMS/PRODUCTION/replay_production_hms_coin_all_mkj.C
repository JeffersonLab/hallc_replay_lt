void replay_production_hms_coin_all_mkj(Int_t RunNumber=0, Int_t MaxEvent=0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/General/hms_coin_replay_production_mkj_%d_%d.root";
  ...
  */
  ...
  analyzer->SetOdefFile("DEF-files/Archive/HMS/PRODUCTION/hstackana_production_all_mkj.def");
  // Define cuts file
  analyzer->SetCutFile("DEF-files/Archive/HMS/PRODUCTION/CUTS/hstackana_production_cuts_mkj.def");    // optional
