void replay_production_hms_coin_cal_calib(Int_t RunNumber=0, Int_t MaxEvent=0, Int_t FirstEvent=0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/50k/hms_coin_replay_production_cal_calib_%d_%d.root";
