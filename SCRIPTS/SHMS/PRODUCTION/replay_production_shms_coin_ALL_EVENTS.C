void replay_production_shms_coin_ALL_EVENTS (Int_t RunNumber = 0, Int_t MaxEvent = 0, Int_t FirstEvent = 1) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/Analysis/50k/shms_coin_replay_production_ALL_EVENTS_%d_%d.root";
  ...
  */
  ...
  // Define cuts file
  analyzer->SetCutFile("DEF-files/PRODUCTION/CUTS/50k/Full_Replay_50k_SHMS_cuts_ALL_EVENTS.def");  // optional
  // File to record accounting information for cuts
  analyzer->SetSummaryFile(Form("REPORT_OUTPUT/Analysis/50k/summary_coin_production_ALL_EVENTS_%d_%d.report", RunNumber, MaxEvent));  // optional
