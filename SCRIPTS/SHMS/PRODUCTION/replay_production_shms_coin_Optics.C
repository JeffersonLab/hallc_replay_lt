void replay_production_shms_coin_Optics (Int_t RunNumber = 0, Int_t MaxEvent = 0, Int_t FirstEvent = 1) {
  ...
  */
  ...
  // Define DEF-file
  analyzer->SetOdefFile("DEF-files/PRODUCTION/50k/Full_Replay_50k_SHMS_Optics.def");
  // Define cuts file
