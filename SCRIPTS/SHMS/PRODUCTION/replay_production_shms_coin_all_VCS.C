void replay_production_shms_coin_all_VCS (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  gHcParms->Load("PARAM/TRIG/tshms_VCS.param");
  ...
  // Define DEF-file
  analyzer->SetOdefFile("DEF-files/SHMS/PRODUCTION/pstackana_production_all_VCS.def");
  // Define cuts file
