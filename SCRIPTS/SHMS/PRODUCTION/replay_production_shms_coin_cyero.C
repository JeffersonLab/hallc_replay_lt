void replay_production_shms_coin_cyero (Int_t RunNumber = 0, Int_t MaxEvent = 0, Int_t FirstEvent = 1) {
  ...
  gHcParms->AddString("g_ctp_database_filename", "~/cafe-2022/cafe_online_replay/DBASE/COIN/standard.database");
  gHcParms->Load(gHcParms->GetString("g_ctp_database_filename"), RunNumber);
  gHcParms->Load(gHcParms->GetString("g_ctp_parm_filename"));
  gHcParms->Load(gHcParms->GetString("g_ctp_kinematics_filename"), RunNumber);
  // Load parameters for SHMS trigger configuration
  gHcParms->Load("~/cafe-2022/cafe_online_replay/PARAM/TRIG/tcoin.param");
  // Load fadc debug parameters
  gHcParms->Load("~/cafe-2022/cafe_online_replay/PARAM/SHMS/GEN/p_fadc_debug.param");
  gHcParms->Load("~/cafe-2022/cafe_online_replay/PARAM/HMS/GEN/h_fadc_debug.param");

  // Load the Hall C detector map
  gHcDetectorMap = new THcDetectorMap();
  gHcDetectorMap->Load("~/cafe-2022/cafe_online_replay/MAPS/COIN/DETEC/coin.map");
  ...
  */
  ...
  // Define crate map
  analyzer->SetCrateMapFileName("~/cafe-2022/cafe_online_replay/MAPS/db_cratemap.dat");
  // Define output ROOT file
  analyzer->SetOutFile(ROOTFileName.Data());
  // Define DEF-file
  analyzer->SetOdefFile("~/cafe-2022/cafe_online_replay/DEF-files/cafe_shms50k.def");
  // Define cuts file
  analyzer->SetCutFile("~/cafe-2022/cafe_online_replay/DEF-files/CUTS/cafe_cuts_shms.def");  // optional
