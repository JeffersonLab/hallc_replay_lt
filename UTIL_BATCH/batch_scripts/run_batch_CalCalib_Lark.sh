...
while true; do
    ...
    case $yn in
		...
		echo "#PBS -N CalCalib_${SPEC}_${runNum}" >> ${batch} # Name your job                                                                           
		...
		echo "#PBS -o  /home/${USER}/trq_output/CalCalib_${SPEC}_${runNum}.out" >> ${batch} # Output directory and file name, set to what you like
		echo "#PBS -e  /home/${USER}/trq_output/CalCalib_${SPEC}.err" >> ${batch} # Error output directory and file name
		echo "date" >> ${batch} 
		...
		echo "./CalCalib_Batch.sh ${runNum} ${SPEC} ${MAXEVENTS}" >> ${batch} # Run your script, change this to what you like
		echo "date">>${batch}
