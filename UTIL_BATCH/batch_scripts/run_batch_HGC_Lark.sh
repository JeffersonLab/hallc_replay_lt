...
while true; do
    ...
    case $yn in
		...
		echo "#PBS -N HGC_Test${runNum}" >> ${batch} # Name your job                                                                           
		...
		echo "date" >> ${batch} 
		echo "cd /home/${USER}/work/JLab/hallc_replay_lt/UTIL_BATCH/" >> ${batch} # Tell your job to go to the directory with the script you want to run
		echo "./Analysis_Scripts/HGC_Test_Lark.csh ${runNum}" >> ${batch} # Run your script, change this to what you like
		echo "date">>${batch}
