#define KaonYield_declow_cxx
// The class definition in KaonYield_declow.h has been generated automatically
...
//
// root> T->Process("KaonYield_declow.C")
// root> T->Process("KaonYield_declow.C","some options")
// root> T->Process("KaonYield_declow.C+")
//


#include "KaonYield_declow.h"
#include <TStyle.h>
#include <TCanvas.h>
#include <TLine.h>
#include <TMath.h>
...
void KaonYield_declow::Begin(TTree * /*tree*/)
{
...
void KaonYield_declow::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t KaonYield_declow::Process(Long64_t entry)
{
...
void KaonYield_declow::SlaveTerminate()
{
...
void KaonYield_declow::Terminate()
{
  ...
  GausBack->SetParLimits(3,1.105,1.135);
  ...
  GausBack->SetParameter(3,1.1175);
  GausBack->SetParameter(4,0.005);
  ...
  Lambda_Fit->SetParLimits(1,1.105,1.135);
  Lambda_Fit->SetParLimits(2,0.0,0.1);
  Lambda_Fit->SetParameter(0,100);
  Lambda_Fit->SetParameter(1,1.1175);
  Lambda_Fit->SetParameter(2,0.005);
