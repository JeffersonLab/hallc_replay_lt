...
#ifndef shms_cal_efficiency_h
#define shms_cal_efficiency_h
...
class shms_cal_efficiency : public TSelector {
 public :
  ...
  ClassDef(shms_cal_efficiency,0);

};

#endif

#ifdef shms_cal_efficiency_cxx
void shms_cal_efficiency::Init(TTree *tree)
{
...
Bool_t shms_cal_efficiency::Notify()
{
...
#endif // #ifdef shms_cal_efficiency_cxx
