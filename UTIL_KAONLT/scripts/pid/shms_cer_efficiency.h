...
#ifndef shms_cer_efficiency_h
#define shms_cer_efficiency_h
...
class shms_cer_efficiency : public TSelector {
 public :
  ...
  ClassDef(shms_cer_efficiency,0);

};

#endif

#ifdef shms_cer_efficiency_cxx
void shms_cer_efficiency::Init(TTree *tree)
{
...
Bool_t shms_cer_efficiency::Notify()
{
...
#endif // #ifdef shms_cer_efficiency_cxx
