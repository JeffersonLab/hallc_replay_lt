...
#ifndef KaonYield_declow_h
#define KaonYield_declow_h
...
class KaonYield_declow : public TSelector {
 public :
  ...
  ClassDef(KaonYield_declow,0);

};

#endif

#ifdef KaonYield_declow_cxx
void KaonYield_declow::Init(TTree *tree)
{
...
Bool_t KaonYield_declow::Notify()
{
...
#endif // #ifdef KaonYield_declow_cxx
