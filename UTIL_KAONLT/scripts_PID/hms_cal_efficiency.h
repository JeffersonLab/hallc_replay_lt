...
#ifndef hms_cal_efficiency_h
#define hms_cal_efficiency_h
...
class hms_cal_efficiency : public TSelector {
 public :
  ...
  ClassDef(hms_cal_efficiency,0);

};

#endif

#ifdef hms_cal_efficiency_cxx
void hms_cal_efficiency::Init(TTree *tree)
{
...
Bool_t hms_cal_efficiency::Notify()
{
...
#endif // #ifdef hms_cal_efficiency_cxx
