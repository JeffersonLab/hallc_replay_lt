void replay_production_coin_HeepSingles (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("UTIL_PROTON/DEF-files/HeepSingles_Production.def");
  // Define cuts file
  analyzer->SetCutFile("UTIL_PROTON/DEF-files/HeepSingles_Production_Cuts.def");  // optional
